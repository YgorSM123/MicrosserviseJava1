...
public class CurrencyController {
	...
	private final CurrencyBCClient currencyBCCliente;
	
	public CurrencyController(CurrencyRepository repository, CurrencyBCClient currencyBCCliente) {
		super();
		this.repository = repository;
		this.currencyBCCliente = currencyBCCliente;
	}
...
//				.orElseThrow(() -> new Exception("Currency not supported!!!"));
		...
		if (source.equals(target)) {
			...
			if (!source.equals("BRL")) {
				CurrencyBCResponse resp = currencyBCCliente.getCurrency(source);
			...
			if (!target.equals("BRL")) {
				CurrencyBCResponse resp = currencyBCCliente.getCurrency(target);
